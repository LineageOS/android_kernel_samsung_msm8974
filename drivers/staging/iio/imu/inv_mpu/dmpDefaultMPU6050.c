...
#define CFG_OUT_PRESS       (1873)
#define CFG_PED_ENABLE      (1986)
#define CFG_OUT_GYRO        (1805)
#define OUT_3QUAT_DAT       (1677)
#define CFG_PEDSTEP_DET     (2842)
#define OUT_GYRO_DAT        (1814)
#define CFG_FIFO_INT        (1984)
#define OUT_CPASS_DAT       (1848)
#define CFG_AUTH            (1099)
#define OUT_ACCL_DAT        (1780)
#define FCFG_1              (1127)
#define FCFG_3              (1152)
#define FCFG_2              (1131)
#define CFG_OUT_CPASS       (1839)
#define FCFG_7              (1138)
#define CFG_OUT_3QUAT       (1667)
#define OUT_PRESS_DAT       (1882)
#define CFG_7               (1349)
#define OUT_PQUAT_DAT       (1746)
#define CFG_OUT_6QUAT       (1702)
#define CFG_PED_INT         (2831)
#define SMD_TP2             (1314)
#define SMD_TP1             (1293)
#define CFG_MOTION_BIAS     (1351)
#define CFG_OUT_ACCL        (1771)
#define CFG_OUT_STEPDET     (1637)
#define OUT_6QUAT_DAT       (1712)
#define CFG_OUT_PQUAT       (1737)
