...
#define CFG_OUT_PRESS       (2015)
#define CFG_PED_ENABLE      (2128)
#define CFG_OUT_GYRO        (1947)
#define OUT_3QUAT_DAT       (1819)
#define CFG_PEDSTEP_DET     (2789)
#define OUT_GYRO_DAT        (1956)
#define CFG_FIFO_INT        (2126)
#define OUT_CPASS_DAT       (1990)
#define CFG_AUTH            (1099)
#define OUT_ACCL_DAT        (1922)
#define FCFG_1              (1127)
#define FCFG_3              (1152)
#define FCFG_2              (1131)
#define CFG_OUT_CPASS       (1981)
#define FCFG_7              (1138)
#define CFG_OUT_3QUAT       (1809)
#define OUT_PRESS_DAT       (2024)
#define CFG_LCD_UP_DOWN_INT (1543)
#define CFG_7               (1349)
#define OUT_PQUAT_DAT       (1888)
#define CFG_OUT_6QUAT       (1844)
#define CFG_PED_INT         (2778)
#define SMD_TP2             (1314)
#define SMD_TP1             (1293)
#define CFG_MOTION_BIAS     (1351)
#define CFG_OUT_ACCL        (1913)
#define CFG_OUT_STEPDET     (1779)
#define OUT_6QUAT_DAT       (1854)
#define CFG_OUT_PQUAT       (1879)
