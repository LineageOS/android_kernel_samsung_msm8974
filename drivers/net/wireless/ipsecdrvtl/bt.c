/*
   'src_nic_vpndbg.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Nov 13 10:03:51 2015
*/
#include"cobf.h"
#ifdef _WIN32
...
bb143 bb1895(bb83 bb78,bb88 bb52);
#ifdef _WIN32
#ifdef bb308
#define bb1533 ( bb107)-1
#include"uncobf.h"
#include<stdarg.h>
#include<stdio.h>
#include"cobf.h"
...
#else
#ifdef bb308
#define bb2608 bb2653
#endif
#define bb1533 ( bb107)-1
#endif
bb40 bb62 bb2034(bbh bbb*bb2350,bbl bb42[32 ]){bb3 bb28=(bb3)bb2350;
bb1313(bb42,"\x25\x64\x2e\x25\x64\x2e\x25\x64\x2e\x25\x64",bb28[0 ],
bb28[1 ],bb28[2 ],bb28[3 ]);bb4 bb42;}bb40 bbd bb2505(bbh bbb*bb2350){
bb3 bb28=(bb3)bb2350;bb4 bb28[0 ]<<24 |bb28[1 ]<<16 |bb28[2 ]<<8 |bb28[3 ];}
bb40 bb62 bb2475(bbf bb2584[6 ],bbl bb42[32 ]){bbf*bb448=bb2584;bb1313(
...
bb1327=bb1533;bbb bb1919(){bbm(bb1327!=bb1533)bb4;
#ifdef UNDER_CE
bb1327=bb2682(bb641("\\\x69\x70\x73\x65\x63\x5f\x6c\x6f\x67\x2e\x74"
"\x78\x74"),bb2697|bb2673,bb2668|bb2733,0 ,bb2713,bb2716,0 );
#else
bb1327=0 ;
#endif
}bbb bb1930(){bbm(bb1327!=bb1533){
#ifdef UNDER_CE
bb2714(bb1327);
#endif
bb1327=bb1533;}}bbb bb155(bbh bbl*bb20,...){bb2606 bb179;bbn bb11;bbl
bb42[256 ];bbm(bb1327==bb1533)bb4;bb2559(bb179,bb20);bb11=bb2608(bb42,
bb12(bb42)-1 ,bb20,bb179);bb42[bb11]=0 ;
#ifdef UNDER_CE
bb2718(bb1327,bb42,bb11,&bb11,bb93);
#else
#ifdef _WIN32
#ifdef bb308
bb2669("\x25\x73",bb42);
#else
bb2724(bb42);bb320("\x25\x73",bb42);
#endif
#else
#ifdef bb308
bb577("\x25\x73",bb42);
...
#ifdef UNDER_CE
bbb bb2064(bb187 bbg){bb187 bb28=bbg;bbm(!bbg){bb155("\x28\x6e\x75"
"\x6c\x6c\x29\n");bb4;}bb110( *bb28){bbm(bb28!=bbg)bb155("\x2c\x20");
bb155("\x25\x6c\x73",bb28);bb28+=bb2681(bb28)+1 ;}bb155("\n");}
#endif
bbb bb2098(bbb*bb2599,bbn bb2603){bbl bb42[256 ];bbl*bb2279=(bbl* )bb2599
;bbl*bb2539=bb2279+bb2603;bbe bb2024=0 ;bbm(bb1327==bb1533)bb4;bb110(
bb2279<bb2539){bbe bbo= *bb2279++;bb42[bb2024++]=bbo>=0 &&bb2580(bbo)?
(bbl)bbo:'.';bbm(bb2024>=(bbe)bb12(bb42)-1 ){bb42[bb2024]=0 ;bb155(""
"\x25\x73",bb42);bb2024=0 ;}}bbm(bb2024>0 ){bb42[bb2024]=0 ;bb155("\x25"
"\x73",bb42);}bb155("\n");}bbb bb2105(bbb*bbx,bbn bb5){bbe bb1813=16 ;
bbn bbz;bbm(bb1327==bb1533)bb4;bb91(bbz=0 ;bbz<bb5;bbz+=bb1813){bbl
bb216[512 ];bbl*bbs=bb216;bbf*bbg=(bbf* )bbx+bbz;bbe bb77;bbs+=bb1313(
bbs,"\x25\x30\x34\x64",bbz);bb91(bb77=0 ;bb77<bb1813;bb77++){bbm(bbz+
bb77+1 <=bb5){bbe bb44=bbg[bb77];bbm(bb77>0 &&bb77%8 ==0 )bbs+=bb1313(bbs
,"\x20\x2d");bbs+=bb1313(bbs,"\x20\x25\x30\x32\x78",bb44);}bb50{bbm(
bb77>0 &&bb77%8 ==0 )bbs+=bb1313(bbs,"\x20\x20");bbs+=bb1313(bbs,"\x20"
"\x20\x20");}} *bbs++=' ';bb91(bb77=0 ;bb77<bb1813;bb77++){ *bbs++=bbz
+bb77<bb5?(bbg[bb77]<0x80 &&bb2580(bbg[bb77])?bbg[bb77]:'.'):' ';} *
bbs++='\n'; *bbs=0 ;bb155("\x25\x73",bb216);}}bbb bb1852(bbb*bbx,bbn
bb5){bbe bb1813=16 ;bbn bbz;bbm(bb1327==bb1533)bb4;bb91(bbz=0 ;bbz<bb5;
bbz+=bb1813){bb40 bbl bb216[512 ];bbl*bbs=bb216;bbf*bbg=(bbf* )bbx+bbz
;bbe bb77;bb91(bb77=0 ;bb77<bb1813;bb77++){bbm(bbz+bb77+1 <=bb5){bbe
bb44=bbg[bb77];bbs+=bb1313(bbs,"\x25\x30\x32\x78",bb44);}} *bbs=0 ;
bb155("\"\x25\x73\"\n",bb216);}}bbb bb1373(bbb*bbx,bbn bb5){bbe bb1813
=16 ;bbn bbz;bbm(bb1327==bb1533)bb4;bb91(bbz=0 ;bbz<bb5;bbz+=bb1813){
bb40 bbl bb216[512 ];bbl*bbs=bb216;bbf*bbg=(bbf* )bbx+bbz;bbe bb77;
bb91(bb77=0 ;bb77<bb1813;bb77++){bbm(bbz+bb77+1 <=bb5){bbe bb44=bbg[
bb77];bbs+=bb1313(bbs,"\\\x78\x25\x30\x32\x78",bb44);}} *bbs=0 ;bb155(""
"\"\x25\x73\"\n",bb216);}}bbb bb1951(){bb504*bbo=bb988.bb1006->bb475;
bb155("\t" "\x62\x50\x47\x50\x6e\x65\x74\x45\x6e\x61\x62\x6c\x65\x64" ""
"\x3a\x25\x64\n",bbo->bb1158);bb155("\t" "\x46\x69\x72\x65\x77\x61"
"\x6c\x6c\x4c\x65\x76\x65\x6c" "\x3a\x25\x64\n",bbo->bb1106);}bbb
bb1779(){bbn bbz;bb35*bb980=bb988.bb1006;bb155("\x6e\x75\x6d\x53\x41"
"\x73\x3a\x25\x64\n",bb980->bb567);bb91(bbz=0 ;bbz<bb980->bb567;bbz++){
bb174*bb28=&bb980->bb528[bbz].bb182;bbn bb77;bb155("\x73\x61\x5b\x25"
"\x64\x5d\n",bbz);bb155("\x20\x20" "\x69\x70\x41\x64\x64\x72\x65\x73"
"\x73" "\x3a\x25\x78\n",bb28->bb29);bb91(bb77=0 ;bb77<bb28->bb1150;
bb77++){bb155("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\x69\x73\x52"
"\x61\x6e\x67\x65" "\x3a\x25\x78\n",bb77,bb28->bb943[bb77].bb1175);
bb155("\x20\x20\x74\x73\x73\x5b\x25\x64\x5d" "\
x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x69\x6e\x41\x75\x74"
"\x68\x4b\x65\x79" "\n");bb1373(bb28->bb425[0 ].bb298.bb313.bb580,bb12
(bb28->bb425[0 ].bb298.bb313.bb580));bb155("\x20\x20\x74\x72\x61\x6e"
"\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65\x73\x70\x2e" "\x6f"
"\x75\x74\x41\x75\x74\x68\x4b\x65\x79" "\n");bb1373(bb28->bb425[0 ].
bb298.bb313.bb570,bb12(bb28->bb425[0 ].bb298.bb313.bb570));bb155("\x20"
"\x20\x74\x72\x61\x6e\x73\x66\x6f\x72\x6d\x5b\x30\x5d\x2e\x75\x2e\x65"
"\x73\x70\x2e" "\x65\x78\x70\x6c\x69\x63\x69\x74\x49\x56" "\n");
bb1373(bb28->bb425[0 ].bb298.bb313.bb1233,bb12(bb28->bb425[0 ].bb298.
bb313.bb1233));bb155("\x20\x20" "\x6c\x6f\x63\x61\x6c\x49\x50\x41\x64"
"\x64\x72\x65\x73\x73" "\x3a\x25\x78\n",bb28->bb608);bb155("\x20\x20"
"\x62\x69\x72\x74\x68\x54\x69\x6d\x65\x3a\x25\x78\n",bb980->bb528[bbz
].bb597);bb155("\x20\x20\x6c\x61\x73\x74\x53\x65\x6e\x64\x54\x69\x6d"
"\x65\x3a\x25\x78\n",bb980->bb528[bbz].bb1194);bb155("\x20\x20\x6c"
"\x61\x73\x74\x52\x65\x63\x76\x54\x69\x6d\x65\x3a\x25\x78\n",bb980->
bb528[bbz].bb1208);}}bbb bb2035(bb370*bb1975){bb370*bb2364=bb1975;bbl
...
"\x25\x78\n",bb2475(bb2364->bb1043,bbg),bb2475(bb2364->bb377,bbs),
bb196(bb2364->bb387));}bbb bb1595(bb330*bb28){bbl bbg[32 ],bbs[32 ];
...
"\n",bb28->bb962,bb196(bb28->bb379),bb196(bb28->bb850),bb196(bb28->
bb602),bb28->bb1037,bb28->bb291,bb2034(&bb28->bb314,bbg),bb2034(&bb28
->bb268,bbs));}bb40 bbb bb2547(bbe bbo,bbl bb42[16 ]){bbl*bb28=bb42;
...
bb1307(bb330*bb854,bb491*bb136){bbl bbg[32 ],bbs[32 ],bbo[16 ];bbm(!
bb136)bb136=(bb319)((bb3)bb854+bb854->bb962*4 );bb2547(bb136->bb170,
bbo);bb155("\x74\x63\x70\x20\x73\x72\x63\x3a\x25\x73\x3a\x25\x64\x2c"
...
"\x64\x2c\x20\x75\x72\x67\x3a\x25\x64\n",bb2034(&bb854->bb314,bbg),
bb196(bb136->bb290),bb2034(&bb854->bb268,bbs),bb196(bb136->bb612),
bb2505(&bb136->bb568),bb2505(&bb136->bb947),(bb136->bb96&0xf0 )>>2 ,bbo
,bb196(bb136->bb158),bb196(bb136->bb1041));}bbb bb1504(bb330*bb854,
bb431*bb1635){bbl bbg[32 ],bbs[32 ];bbm(!bb1635)bb1635=(bb362)((bb3)bb854
+bb854->bb962*4 );bb155("\x75\x64\x70\x20\x73\x72\x63\x3a\x25\x73\x3a"
"\x25\x64\x2c\x20\x64\x65\x73\x74\x3a\x25\x73\x3a\x25\x64\n",bb2034(&
bb854->bb314,bbg),bb196(bb1635->bb290),bb2034(&bb854->bb268,bbs),
bb196(bb1635->bb440));}
