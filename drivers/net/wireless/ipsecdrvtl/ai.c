/*
   'crt.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Nov 13 10:03:51 2015
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
#ifdef _WIN32
bbb*bb128(bb32 bb48){bb40 bb2678 bb2458=bb2693(-1 ,-1 );
#ifdef UNDER_CE
bb31 bb28;bb2609(&bb28,bb48+4 ,0 ,bb2458);bbm(bb28) *bb28++=bb48;
#else
bb80 bb28;bb2609(&bb28,bb48,0 ,bb2458);
#endif
bb4 bb28;}bbb bb109(bbb*bb28){bbm(!bb28)bb4;
#ifdef UNDER_CE
bb2545((bb31)bb28-1 ,((bb31)bb28)[-1 ],0 );
#else
bb2545(bb28,0 ,0 );
#endif
}bbb*bb138(bb32 bb159,bb32 bb48){bbb*bb28;bb48*=bb159;bb28=bb128(bb48
);bbm(bb28)bb961(bb28,0 ,bb48);bb4 bb28;}
#endif
#ifndef _WIN32
bbe bb145(bbh bbl*bb99,bbh bbl*bb26,bbt bb216){bb577(bb2688"\x61\x73"
"\x73\x65\x72\x74\x20\x66\x61\x69\x6c\x75\x72\x65\x3a\x20\x25\x73\x2c"
"\x20\x25\x73\x28\x25\x64\x29\n",bb99,bb26,bb216);bb4 0 ;}
#endif
bb43 bb305(bb43*bb325){bb43 bb47;
#ifdef _WIN32
bb2727 bb2159;bb2692(&bb2159);bb47=(bb43)((bb2159.bb2687-
116444736000000000i64 )/10000000i64 );
#else
bbj bb2709 bb2159;bb2658(&bb2159);bb47=(bb43)bb2159.bb2680;
#endif
bbm(bb325) *bb325=bb47;bb4 bb47;}
#ifndef _WIN32
bbe bb331(bbh bbl*bbg){bb577("\x25\x73\n",bbg);bb4 0 ;}bbe bb320(bbh
bbl*bb20,...){bbl bb42[256 ];bbe bb11;bb2606 bb179;bb2559(bb179,bb20);
bb11=bb2653(bb42,bb12(bb42)-1 ,bb20,bb179);bb42[bb12(bb42)-1 ]=0 ;bb577(""
