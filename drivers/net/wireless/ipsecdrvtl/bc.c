/*
   'src_compress_deflate_infutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Fri Nov 13 10:03:51 2015
*/
#include"cobf.h"
#ifdef _WIN32
...
{bbe bb463;};bbj bb1329{bbe bb463;};bbe bb413(bbg,bb0,bb24)bb310*bbg;
bb16 bb0;bbe bb24;{bb9 bb11;bb33*bb28;bb33*bb87;bb28=bb0->bb620;bb87=
bbg->bb376;bb11=(bb9)((bb87<=bbg->bb199?bbg->bb199:bbg->bb462)-bb87);
bbm(bb11>bb0->bb396)bb11=bb0->bb396;bbm(bb11&&bb24==(-5 ))bb24=0 ;bb0->
bb396-=bb11;bb0->bb637+=bb11;bbm(bbg->bb1582!=0 )bb0->bb378=bbg->bb499
=( *bbg->bb1582)(bbg->bb499,bb87,bb11);bb75(bb28,bb87,bb11);bb28+=
bb11;bb87+=bb11;bbm(bb87==bbg->bb462){bb87=bbg->bb158;bbm(bbg->bb199
==bbg->bb462)bbg->bb199=bbg->bb158;bb11=(bb9)(bbg->bb199-bb87);bbm(
bb11>bb0->bb396)bb11=bb0->bb396;bbm(bb11&&bb24==(-5 ))bb24=0 ;bb0->
bb396-=bb11;bb0->bb637+=bb11;bbm(bbg->bb1582!=0 )bb0->bb378=bbg->bb499
=( *bbg->bb1582)(bbg->bb499,bb87,bb11);bb75(bb28,bb87,bb11);bb28+=
bb11;bb87+=bb11;}bb0->bb620=bb28;bbg->bb376=bb87;bb4 bb24;}
